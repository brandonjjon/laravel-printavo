...
use Brandonjjon\Printavo\Data\Generated\Enums\TransactionSource;
use Carbon\Carbon;
 ...
 */
readonly class Payment extends BaseData
{
    /**
    ...
    public static function fromArray(array $data): static
    {
        ...
        $source = isset($data['source']) ? TransactionSource::tryFrom($data['source']) : null;
