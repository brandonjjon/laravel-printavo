...
use Brandonjjon\Printavo\Data\Generated\Order;
use Brandonjjon\Printavo\PrintavoClient;
use Brandonjjon\Printavo\Query\Builder;

/**
 * Query builder for orders collection.
 *
...
class OrdersBuilder extends Builder
{
     ...
     */
    protected string $singularResource = 'order';
     ...
     */
    protected string $dataClass = Order::class;
    ...
    public function __construct(PrintavoClient $client)
    {
        ...
        $this->selects = Order::defaultFields();
    }
